...
% Front matter
\input{Report/frontmatter/skripsie_title_page}
%\input{frontmatter/masters_title_page}
\pagenumbering{roman}
\input{Report/frontmatter/acknowledgements}
\input{Report/frontmatter/declaration}
\input{Report/frontmatter/abstract}
\tableofcontents
\listoffigures
\listoftables
\input{Report/frontmatter/nomenclature}
\newpage
\pagenumbering{arabic}

% Contents
\input{Report/introduction/introduction}
\input{Report/literature_study/literature_study}
\input{Report/general_design/general_design}
\input{Report/detail_design/detail_design}
\input{Report/testing/testing}
